...
if __name__ == "__main__":
    ...
    copytree(path.join(sources_dir, 'utils'), path.join(temp_dir, 'ru_transcript', 'utils'), copy_function=copy)
    copy(path.join(sources_dir, 'ru_transcript.py'), path.join(temp_dir, 'ru_transcript', 'ru_transcript.py'))
