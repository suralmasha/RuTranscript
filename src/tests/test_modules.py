...
from ru_transcript.src.tools.main_tools import text_norm_tok
...
class TestModules(unittest.TestCase):
    ...
    def test_stress_one_syllable(self):
        ...
        self.assertEqual('но+с', ru_transcript.get_stressed_text())
    ...
    def test_stress_yo(self):
        ...
        ru_transcript.transcribe()
        print(testing_text, ru_transcript.get_stressed_text())
        self.assertEqual('ё+лка', ru_transcript.get_stressed_text())
    ...
    def test_error_stress(self):
        ...
        ru_transcript.transcribe()
        print(testing_text, ru_transcript.get_stressed_text())
        self.assertEqual('литературнохудо+жественный', ru_transcript.get_stressed_text())
