...
class TestConsonants(unittest.TestCase):
    ...
    def test_fricative_g_1(self):
        ...
        self.assertEqual(['γʷ', 'o', 's', 'p', 'ə', 'dʲ', 'ɪ'], ru_transcript.allophones)
    ...
    def test_fricative_g_2(self):
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['a', 'γ', 'd', 'ʌ'], ru_transcript.allophones)
    ...
    def test_nasal_m_n(self):  # 'м' / 'н' перед губно-зубными согласными
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['a', 'ɱ', 'f', 'ə', 'r', 'ʌ'], ru_transcript.allophones)
    ...
    def test_silent_r(self):  # 'р' перед глухими согласными и в конце слова
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['a', 'r̥', 'f', 'ʌ'], ru_transcript.allophones)
    ...
    def test_long_sh(self):  # долгий 'ш', в сочетании 'сш'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['ʂːˠ', 'ɨ', 'tʲ'], ru_transcript.allophones)
    ...
    def test_ts(self):  # 'ц'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['t͡s', 'ɐ.', 'p', 'lʲ', 'æ.'], ru_transcript.allophones)
    ...
    def test_voiced_ts(self):  # 'ц' перед звонкой согласной
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['p', 'l', 'ɐ', 'd̻͡z̪', 'd', 'a', 'r', 'm'], ru_transcript.allophones)
    ...
    def test_shch_1(self):  # 'щ'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['ɕː', 'ə', 'ɡʷ', 'o', 'l'], ru_transcript.allophones)
    ...
    def test_shch_3(self):  # сочетания 'сч', 'зч', 'жч'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['ɕː', 'ɪ', 't', 'a', 'tʲ'], ru_transcript.allophones)
    ...
    def test_ch(self):  # 'ч'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['tʲ', 'e', 't͡ɕ'], ru_transcript.allophones)
    ...
    def test_long_ge_2(self):  # 'щ' пред звонкой согласной
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['vʲ', 'ɪ', 'ʑː', 'dʷ', 'o', 'k'], ru_transcript.allophones)
    ...
    def test_long_ge_3(self):  # сочетание 'зж'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['z', 'ɐ', 'j', 'e', 'ʑːˠ', 'ɨ', 'j'], ru_transcript.allophones)
    ...
    def test_j_1(self):  # 'й'
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['m', 'a', 'j'], ru_transcript.allophones)
    ...
    def test_j_2(self):  # йотированный гласный после разделительных ъ и ь
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['ə', 'bʲ', 'j', 'ɪ', 'v', 'lʲ', 'e', 'nʲ', 'j', 'æ.'], ru_transcript.allophones)
    ...
    def test_j_3(self):  # йотированный гласный между двумя гласными
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['z', 'a', 'j', 'ɪ.', 't͡s'], ru_transcript.allophones)
    ...
    def test_j_5(self):  # йотированный гласный в начале слова
        ...
        print(testing_text, ru_transcript.allophones)
        self.assertEqual(['ʝ', 'æ', 'x', 't', 'ʌ'], ru_transcript.allophones)
