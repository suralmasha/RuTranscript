...
class TestPhrases(unittest.TestCase):
    ...
    def test_readme_transcription(self):
        ...
        self.assertEqual(['k', 'a', 'k', 'p', 'ə', 'lʷ', 'ʊ', 't͡ɕ', 'i', 'tʲ', 't', 'r', 'ɐ', 'n', 's', 'k', 'rʲ',
                          'i', 'p', 't͡sˠ', 'ɨ', 'jᶣ', 'ᵿ'], ru_transcript._allophones_list)
    ...
    def test_readme_comma(self):
        ...
        self.assertEqual(['mˠ', 'ɨ', 'ʂ', 'k', 'ʌ', 'kʷ', 'o', 'ʂ', 'k', 'ʌ', 'i', 's', 'ɐ', 'b', 'a', 'k', 'ʌ'],
                         ru_transcript._allophones_list)
    ...
    def test_1(self):
        ...
        self.assertEqual('i nʲ ɪ k ɐ ɡ d a | nʲ ɪ vʲ j ɪ dʲ i n ə j s a m ə j ᵿ bʷ o ɡ ə j s a m ə j f ə n t ɐ sʲ tʲ '
                         'i t͡ɕ ə s k ə j pʲ ɪ. tʲ ɪ r bʷ u r ʐ s k ə j k ɐ m p a nʲ ɪ i | mʲ ɪ nʲ æ nʲ ɪ. ə bʲ j ɪ '
        ...
        self.assertEqual(['i', 'nʲ', 'ɪ', 'k', 'ɐ', 'ɡ', 'd', 'a', 'nʲ', 'ɪ', 'vʲ', 'j', 'ɪ', 'dʲ', 'i', 'n', 'ə', 'j',
                          ...
                          'ɪ', 'j', 'ɪ.', 'm'], ru_transcript._allophones_list)
    ...
    def test_2(self):
        ...
        self.assertEqual('n ɐ p rʷ o tʲ ɪ v a ɡ nʲ ɪ i f r a n t͡s ə v nˠ ᵻ | ᵿ mʲ ɪ nʲ æ bˠ ɨ l ʌ sʲ i lʲ n ə j æ. ɐ '
                         'rʷ u ʐ j æ. | vʲ e ʐ lʲ ɪ v ə sʲ tʲ ||', ru_transcript.transcription)
        print(testing_text, ru_transcript._allophones_list)
        self.assertEqual(['n', 'ɐ', 'p', 'rʷ', 'o', 'tʲ', 'ɪ', 'v', 'a', 'ɡ', 'nʲ', 'ɪ', 'i', 'f', 'r', 'a', 'n',
                          ...
                          'sʲ', 'tʲ'], ru_transcript._allophones_list)
    ...
    def test_6(self):
        ...
        ru_transcript.transcribe()
        print(testing_text, ru_transcript.transcription)
        self.assertEqual('nʲ ɪ. ᵿ k lᶣ ʉ ʐ j æ. ɪ. pʲ ɪ ɡ r a mːˠ ᵻ ||', ru_transcript.transcription)
        print(testing_text, ru_transcript._allophones_list)
    ...
    def test_8(self):
        ...
        self.assertEqual('x ɐ tʲ æ n ə i bʷ o lʲ ɪ. j æ. t͡ɕᶣ ᵿ dʷ o vʲ ɪ ɕː nˠ ᵻ j æ. ɪ. p ɐ tʲ i rʷ ʊ jᶣ ᵿ ɕː ɪ j æ. '
                         'p ɐ d rʷ o b n ə sʲ tʲ ɪ l a ɡʲ ɪ. r n ɐ j ʐˠ ɨ zʲ nʲ ɪ | ʝ æ k a k ɡ ə v ɐ rʲ i t͡s ə ə pʷ '
        ...
        self.assertEqual(['x', 'ɐ', 'tʲ', 'æ', 'n', 'ə', 'i', 'bʷ', 'o', 'lʲ', 'ɪ.', 'j', 'æ.', 't͡ɕᶣ', 'ᵿ', 'dʷ', 'o',
                          ...
                          'ɐ', 'rʲ', 'i', 't͡s', 'ə', 'ə', 'pʷ', 'ʊ', 'sʲ', 'tʲ', 'i', 'l'], ru_transcript._allophones_list)
    ...
    def test_yo(self):
        ...
        self.assertEqual(['ʝᶣ', 'ɵ', 'l', 'k', 'ʌ', 'd', 'lʲ', 'æ', 'j', 'ɪ', 'jᶣ', 'ɵ', 'jᶣ', 'ɵ', 'ʐˠ', 'ɨ', 'k', 'ʌ',
                          ...
                          'mᶣ', 'ɵ', 't'], ru_transcript._allophones_list)
    ...
    def test_skipping_enclitic(self):
        ...
        ru_transcript.transcribe()
        print(testing_text, ru_transcript.transcription)
        self.assertEqual('d ɐ e t ə ʐ ə pʲ ɪ s a tʲ ɪ. lʲ ||', ru_transcript.transcription)
        print(testing_text, ru_transcript._allophones_list)
